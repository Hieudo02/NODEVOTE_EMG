...
#pragma region sendDataToMaster
  if (_ESPNow.FIFODataCuaNodeGuiLenMaster.size() > 0) {
    ...
    // if (DuLieuDangXuLyTuFIFO == NULL) {
    //   Serial.println("NULL");
    // }

    // Serial.print("Final data to master: ");
    // Serial.println(DuLieuDangXuLyTuFIFO);
    ...
    // for (const std::string& str : _ESPNow.FIFODataCuaNodeGuiLenMaster) {
