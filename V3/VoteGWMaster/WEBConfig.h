...
<html lang="en">
    ...
    <table style="width: 100%">
        ...
        <tr>
            <td style="text-align: right; padding: 5px">Position:</td>
            <td style="text-align: left; width: 50%"><input id="tbxPosition" value="-10,114"></td>
        </tr>
        <tr>
...
async function LuuThongTinServerVaoEEPROM() {
    ...
    var Position = document.getElementById("tbxPosition").value;
    xhttp.open("GET","/LuuThongTinServerVaoEEPROM?Realm=" + Realm + "&IPHost=" + IPHost + "&Port=" + Port + "&Position=" + Position, true);
